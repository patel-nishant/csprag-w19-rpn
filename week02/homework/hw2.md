...
<footer>
  ...
  <p class="text-right">
    <a href="/docs">Documentation</a> | <a href="/blog">Blog</a> | <a href="/press-kit">Press Kit</a> | <a href="/careers">Careers</a> | <a href="/legal">Legal</a> | <a href="http://twitter.com/teamKatacoda" target="_blank" rel="noreferrer">@teamKatacoda</a> | <a href="/cdn-cgi/l/email-protection#70361f051e14150203303b110411131f14115e131f1d"><span class="__cf_email__" data-cfemail="7e38110b101a1b0c0d3e351f0a1f1d111a1f501d1113">[email&#160;protected]</span></a>
  </p>
</footer>
    ...
    <script type="text/javascript">
      ...
      window.on_application_load = function(app) {
          mixpanel.identify("nishp04@gmail.com");
          mixpanel.people.set({
            "$email": "nishp04@gmail.com",
            "$created": "2019-01-30T23:24:32.130Z",
            "$last_login": new Date(),
            "$name": 'nishp04@gmail.com',
          });
          app.set_user({
            "id": "",
            "username": "nyb8mo",
            "public_username": "nyb8mo",
            "email": "nishp04@gmail.com",
            "created_at": "2019-01-30T23:24:32.130Z",
            "name": ''
          });
      }
...
## Question 3
``` 3
commit 2c6613626bb6b9419460ed6e9fb83c57f3fba822
Author: mnishant <nishant@253-3.synergydsl.com>
Date:   Wed Jan 30 19:02:38 2019 -0500

    added gitignore

diff --git a/.gitignore b/.gitignore
new file mode 100644
index 0000000..40f2c2a
--- /dev/null
+++ b/.gitignore
@@ -0,0 +1,4 @@
+filter_test
...
commit a7448b90a71a2937bcf1099b8e658f966d6c534d
Author: mnishant <nishant@253-3.synergydsl.com>
Date:   Wed Jan 30 18:56:09 2019 -0500
...
## Question 6
``` 6
This means that Emacs uses the terminal from which it was launched for all its display and input.
```
